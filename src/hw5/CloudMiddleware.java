...
import hw4.CloudData;
import hw4.ServerInfo;
...
public class CloudMiddleware {
    ...
    private List<hw4.ServerInfo> servers;
    ...
    class MiddlewareThread implements Runnable {
        ...
        public void run() {
            try {
                ...
                hw4.ServerInfo server = servers.get(hashKey % servers.size());
    ...
    public void addServer(String addr, int port){
        this.servers.add(new hw4.ServerInfo(addr,port));
    }
